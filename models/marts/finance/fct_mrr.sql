...
{% set import_subscriptions =  unit_testing_select_table( ref('dim_subscriptions'), ref('unit_dim_subscriptions')) %}
{% set import_dates = unit_testing_select_table( ref('int_dates'), ref('unit_int_dates'))  %}
...
final AS (
    SELECT
        ...
        mrr AS mrr_amount,
        {{- rolling_average_periods('mrr', 'mrr_with_changes.user_id', periods=3, order_by='date_month') -}} ,
        mrr_change,
